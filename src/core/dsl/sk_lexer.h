...
typedef enum sk_token_kind : u32
{
    ...
    SK_TOKEN_KWORD_PRINT,
    SK_TOKEN_KWORD_INSTALL,
    SK_TOKEN_KWORD_RPATH,
    SK_TOKEN_KWORD_DEPLOY,
    SK_TOKEN_KWORD_BUNDLE,
    SK_TOKEN_KWORD_PACKAGE,
    SK_TOKEN_KWORD_EXIT,
...
static const char *SK_TOKEN_STR[TOKEN_KIND_COUNT] = {
    ...
    [SK_TOKEN_KWORD_PRINT]    = "SK_TOKEN_KWORD_PRINT",
    [SK_TOKEN_KWORD_INSTALL]  = "SK_TOKEN_KWORD_INSTALL",
    [SK_TOKEN_KWORD_RPATH]    = "SK_TOKEN_KWORD_RPATH",
    [SK_TOKEN_KWORD_DEPLOY]   = "SK_TOKEN_KWORD_DEPLOY",
    [SK_TOKEN_KWORD_BUNDLE]   = "SK_TOKEN_KWORD_BUNDLE",
    [SK_TOKEN_KWORD_PACKAGE]  = "SK_TOKEN_KWORD_PACKAGE",
    [SK_TOKEN_KWORD_EXIT]     = "SK_TOKEN_KWORD_EXIT",
